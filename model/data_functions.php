<?php
    ...
    function getItemArrayOrdered($order) {//Gets the item array, returning it.
        $myQuery = "SELECT * FROM items";
        
        switch($order) {
            case 'alphabetical':
                $myQuery .= " ORDER BY item_name";
                break; 
            case 'price-desc': 
                $myQuery .= " ORDER BY price DESC"; 
                break; 
            case 'price-ascending': 
                $myQuery .= " ORDER BY price"; 
                break;  
        }
    ...
    function getItemArray() {
        return getItemArrayOrdered("price-desc"); 
    }
